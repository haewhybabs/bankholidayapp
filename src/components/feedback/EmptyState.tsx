...
export const EmptyState = ({
    ...
    <View className="flex-1 justify-center items-center p-10 mt-10" testID={testID}>
        ...
        {onRetry && (
            <Button testID={`${testID}-retry-button`} label="Refresh Data" onPress={onRetry} variant="outline" className="w-full" />
        )}
    </View>
);